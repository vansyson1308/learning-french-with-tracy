...
| Hosted privacy-policy URL and support contact — RESOLVED 2026-09-07 | the site is live at https://vansyson1308.github.io/learning-french-with-tracy/ (Pages enabled by the owner; HTTP 200 over HTTPS verified by the `verify` job of Pages run 34164579825); the support email `duymank250997@gmail.com` (provisional) is on the support and privacy pages | `PUBLICATION_STATUS.md`, `PRIVACY_FINAL.md`, `release/support-contact.json` |
