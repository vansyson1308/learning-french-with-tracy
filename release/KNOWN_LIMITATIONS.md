...
| Hosted privacy-policy URL and support contact | the site deploys from `main` via GitHub Pages (enabled by the owner on 2026-09-08); the support email `duymank250997@gmail.com` is set (provisional) and rendered on the support and privacy pages; the privacy URL counts as live only after an HTTP 200 is observed | `PUBLICATION_STATUS.md`, `PRIVACY_FINAL.md`, `release/support-contact.json` |
