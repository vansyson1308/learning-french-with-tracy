...
const errors = [...content.errors, ...lexicon.errors, ...pedagogy.errors];
const warnings = [...content.warnings, ...lexicon.warnings, ...pedagogy.warnings];
...
console.log("content validation passed (packs + registry + rich lexicon + pedagogy)");
