...
describe("committed lexicon data", () => {
  ...
  test("triple lock holds: rich lexicon ≡ frozen map ≡ runtime map (91 ids)", () => {
    ...
    expect(Object.keys(rich).length).toBe(91); // 54 originals (sacrosanct) + 17 Unit A + 7 Unit B + 13 Unit C
  });
