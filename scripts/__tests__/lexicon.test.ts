...
describe("committed lexicon data", () => {
  ...
  test("triple lock holds: rich lexicon ≡ frozen map ≡ runtime map (97 ids)", () => {
    ...
    expect(Object.keys(rich).length).toBe(97); // 54 originals + 17 Unit A + 7 Unit B + 13 Unit C + 6 Unit D
  });
