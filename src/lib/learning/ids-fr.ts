...
export const FR_LEXEME_IDS: Readonly<Record<string, string>> = {
  ...
  "le héros": "fr:w:heros",
  "le train": "fr:w:train",
  "le magasin": "fr:w:magasin",
  "le prix": "fr:w:prix",
  "la porte": "fr:w:porte",
  "le matin": "fr:w:matin",
  "le soir": "fr:w:soir",
  "demain": "fr:w:demain",
  "aujourd'hui": "fr:w:aujourdhui",
  "samedi": "fr:w:samedi",
  "dimanche": "fr:w:dimanche",
  "ouvert": "fr:w:ouvert",
  "ouvrir": "fr:w:ouvrir",
  "fermer": "fr:w:fermer",
  "acheter": "fr:w:acheter",
  "coûter": "fr:w:couter",
  "vouloir": "fr:w:vouloir",
  "prendre": "fr:w:prendre",
  "payer": "fr:w:payer",
  "travailler": "fr:w:travailler",
  "le restaurant": "fr:w:restaurant",
  "le départ": "fr:w:depart",
  "la voie": "fr:w:voie",
  "la place": "fr:w:place",
  "la table": "fr:w:table",
  "la plage": "fr:w:plage",
  "l'entrée": "fr:w:entree",
  "la sortie": "fr:w:sortie",
};
